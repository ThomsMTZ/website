...
import studyLottie from '@/app/assets/lottie/study.json';
import LottieWrapper from '../../helper/lottie-wrapper';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="flex justify-center items-start">
            <div className="w-3/4 h-3/4">
              <LottieWrapper animationPath={studyLottie} />
            </div>
          </div>

          <div>
            <div className="flex flex-col gap-6">
              {t.education.list.map(edu => (
